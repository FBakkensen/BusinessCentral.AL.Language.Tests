#!/usr/bin/env python3
"""
Run AL language coverage test codeunits against BC.

Usage:
  python3 run-bc-tests.py                        # run all discovered codeunits
  python3 run-bc-tests.py --ids "60010,60011"    # run specific codeunits
  python3 run-bc-tests.py --workers 1            # sequential (safer for shared tables)
  python3 run-bc-tests.py --output results.json  # custom output path

Credentials (in priority order):
  1. BC_USERNAME / BC_PASSWORD environment variables
  2. .bcconfig.json in this directory
  3. Local dev defaults: BCRUNNER / Admin123!
"""
